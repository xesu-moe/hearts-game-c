 ...
 * @deps-requires: contract.h (ContractDef, MAX_CONTRACT_DEFS),
 *                 host_action.h (HostActionDef, MAX_HOST_ACTION_DEFS),
 *                 revenge.h (RevengeDef, MAX_REVENGE_DEFS),
 *                 character.h (CharacterDef, MAX_CHARACTER_DEFS)
...
/* Initialize all definition tables with hardcoded data.
