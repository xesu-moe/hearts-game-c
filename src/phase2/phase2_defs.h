...
/* ============================================================
 * @deps-exports: g_contract_defs, g_vendetta_defs, g_transmutation_defs,
 *                g_character_defs, g_contract_def_count, g_vendetta_def_count,
 *                g_transmutation_def_count, g_character_def_count, phase2_defs_init(),
 *                phase2_get_contract(), phase2_get_vendetta(),
 *                phase2_get_transmutation(), phase2_get_character()
 * @deps-requires: contract.h, vendetta.h, transmutation.h, character.h
 * @deps-used-by: vendetta_logic.c, contract_logic.c, transmutation_logic.c, json_parse.c,
 *                render.c, pass_phase.c, turn_flow.c, update.c, info_sync.c, main.c
 * @deps-last-changed: 2026-03-19 — Extended used_by: render.c, game modules use defs
 * ============================================================ */
...
extern VendettaDef  g_vendetta_defs[MAX_VENDETTA_DEFS];
extern int          g_vendetta_def_count;
